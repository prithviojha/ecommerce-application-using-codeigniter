...
<html>
<head>
    <title>Edit Product - CodeBit Shop</title>
    ...
    <div class="col l12 m12 s12">
      <div class="card">
        <div class="card-content">
          <h5 style="margin-top: 0px;font-size: 20px;font-weight: 500;margin-bottom: 0px;">Edit Product</h5>
        </div>
        <div class="card-content" style="padding: 20px;">
          <?= form_open_multipart('admin/update_product/'.$product[0]->id);?>
          <h6 style="font-size: 14px;font-weight: 500;">Product Name</h6>
          <input type="text" name="product_title" id="input_box" value="<?= $product[0]->product_title;?>" placeholder="Product Name" required>
          ...
          <input type="text" name="color" id="input_box" placeholder="Enter Product Color" value="<?= $product[0]->color;?>" style="width: 40%;">
          <h6 style="font-size: 14px;font-weight: 500;">Weight</h6>
          <input type="text" name="weight" id="input_box" value="<?= $product[0]->weight;?>" placeholder="Enter Product weight" style="width: 40%;">
          <h6 style="font-size: 14px;font-weight: 500;">Price</h6>
          <input type="text" name="price" id="input_box" placeholder="Eg: 150"  value="<?= $product[0]->price;?>" required style="width: 40%;">
          <h6 style="font-size: 14px;font-weight: 500;">Image</h6>
          <img src="<?=base_url().'uploads/product_image/'.$product[0]->image;?>" style="width: 100px;height: 100px;border: 2px dashed silver;">
          ...
          <a href="<?= base_url('admin/manage_products');?>" class="btn waves-effect waves-light" style="background: red;box-shadow: none;text-transform: capitalize;font-weight: 500;height: 40px;margin-top: 15px;line-height: 40px;">Cancel</a>
          <?= form_close(); ?>
