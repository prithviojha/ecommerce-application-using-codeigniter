...
<html>
<head>
    <title>Add category - CodeBit Shop</title>
    ...
    <div class="col l6 m6 s12">
      ...
      <div class="card">
        <div class="card-content">
          <h5 style="margin-top: 0px;font-size: 20px;font-weight: 500;margin-bottom: 0px;text-align: center;">Add Category</h5>
        </div>
        <div class="card-content" style="padding: 20px;">
          ...
          <input type="text" name="category_name" id="input_box" placeholder="Category Name" required>
          <small class="red-text">Eg: Biscuts, Breads</small>
          <h6 style="font-size: 14px;font-weight: 500;">Image</h6>
          <input type="file" name="category_image" id="input_upload" placeholder="Category Name" required>
          <small style="margin-top:0px;margin-bottom: 15px;color: red;">Max. Image Size : 2MB | 100px * 100px</small>
          <button type="submit" class="btn waves-effect waves-light" style="background: #ff3d00;margin-top: 15px;text-transform: capitalize;width: 100%;height: 40px;box-shadow: none;">Save Category</button>
          </form>
