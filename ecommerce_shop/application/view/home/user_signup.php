    	...
    	<div class="col l4 m4 s12">
    		...
    		<div class="card">
    			<div class="card-contain" style="margin-left: 10px; margin-right: 10px;padding-bottom: 10px;padding-top: 10px;">
    				...
    				<input type="Password" name="retype_password" id="input_box" onkeyup="check_password()" placeholder="xxxxxxxx">
    				<h6 style="font-size: 14px;color: grey;font-weight: 500;">Address</h6>
    				<textarea name="address" placeholder="Enter your Address"></textarea>
    				 <button type="submit" id="btn_register_now" class="btn waves-effect" style="background: black;width: 100%;box-shadow: none;margin-bottom: 5px; text-transform: capitalize;">Register Now</button>
                    <h6 style="font-size: 14px;color: grey;font-weight: 500;text-align: center;text-transform: capitalize;">I have already Account</h6>
                    <a href="<?= base_url('home/user_signin') ;?>" class="btn waves-effect" style="background: #002366;width: 100%;box-shadow: none;margin-bottom: 5px;text-transform: capitalize;">Sign In</a>
    			</div>
                <?= form_close();?>
    		</div>
    		<!-- card section -->
